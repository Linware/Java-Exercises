 ...
 * @author Jonan
 */
@WebServlet(name = "ServletObtenerListaOperacionesBancarias", urlPatterns = {"/ServletObtenerListaOperacionesBancarias"})
public class ServletObtenerListaOperacionesBancarias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Operaciones> o= bancoEJB.findAll();
