...
<html>
    ...
    <body class="container bg-info">
        <h1>Bienvenida a "BancoServlet".Por favor,seleccione la acción que quiere realizar(Los botones azules son las funciones que estan implementadas,los amarillos aun tienen algun fallo y los rojos estan sin hacer; los de los HTML funcionan todos)</h1>
        <h2>--------------------------------------------------------------------</h2>
        <form action="insertarCuenta.html" method="POST">Presiona el botón para insertar una nueva cuenta
            <input type="submit" name="insertCuenta" value="Enviar" class="btn btn-warning"></form>
        ...
        <form action="ServletModificarDatos" method="POST">Presiona el botón para modificar los datos de un propietario
            <input type="submit" name="enviar" value="Enviar" class="btn btn-danger"></form>
        ...
        <form action="ServletObtenerListaOperacionesBancarias" method="POST">Presiona el botón para ver todas las operaciones bancarias
            ...
            <input type="submit" name="ServletInsertarOperacionBancaria" value="Enviar" class="btn btn-danger"></form>
