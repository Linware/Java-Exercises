...
public class HadmonApp {

    private static final Logger log = LoggerFactory.getLogger(HadmonApp.class);

    private final Environment env;

    public HadmonApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HadmonApp.class);
